...
idf.py -B build/cyd-default set-target esp32
idf.py -B build/cyd-default build
...
idf.py -B build/cyd-touch-off set-target esp32
idf.py -B build/cyd-touch-off -D CMAKE_C_FLAGS="-DCYD_FEATURE_TOUCH=0 -DCYD_FEATURE_IMAGE_LOADING=1" build
...
idf.py -B build/cyd-image-off set-target esp32
idf.py -B build/cyd-image-off -D CMAKE_C_FLAGS="-DCYD_FEATURE_TOUCH=1 -DCYD_FEATURE_IMAGE_LOADING=0" build
...
idf.py -B build/cyd-touch-image-off set-target esp32
idf.py -B build/cyd-touch-image-off -D CMAKE_C_FLAGS="-DCYD_FEATURE_TOUCH=0 -DCYD_FEATURE_IMAGE_LOADING=0" build
